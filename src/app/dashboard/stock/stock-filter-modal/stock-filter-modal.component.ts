...
export class StockFilterModalContext extends BSModalContext {
  public product: any;
}

@Component({
  selector: 'stock-filter-modal',
  //TODO: [ngClass] here on purpose, no real use, just to show how to workaround ng2 issue #4330.
  // Remove when solved.
  /* tslint:disable */
  templateUrl: './stock-filter-modal.component.html',
  styleUrls: ['./stock-filter-modal.component.scss']
})
export class StockFilterModal implements OnInit, ModalComponent<StockFilterModalContext> {
  public subscribers: any = {};
  public context: StockFilterModalContext;
  ...
  constructor(
      public dialog: DialogRef<StockFilterModalContext>,
